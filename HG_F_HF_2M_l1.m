...
Gauss_op2=Gauss_op1(rp11(1:M),:);
Gauss_op=[real(Gauss_op2);imag(Gauss_op2)];
Gauss_op2 = [];
Gauss_op3 = [];
...
grid
%success_Gauss
legend('Random Gaussian', 'Partial Fourier matrix','Partial Wash-Hadamard matrix', 'Golay-paired Hadamard matrix');
